...
- Building a fault-tolerant PyTorch training lab with deterministic checkpoints and restart verification.
- Hardening a clean-room Go validation platform around idempotency, bounded retries, dead letters, and failure injection.
- Developing VoiceMed AI as a synthetic-data, schema-constrained, human-reviewed documentation prototype.
- Publishing reproducible AI engineering notes through the AI Journey.

## Core stack

`Go` `Java` `Python` `Kubernetes` `OpenTelemetry` `PostgreSQL` `PyTorch`
...
| [AI Journey](https://github.com/ajaykr0905/ai-journey) | Evidence-backed learning notes and implementations | Ongoing |
